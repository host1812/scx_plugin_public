...
class AIXLPPFile(Installer):
    ...
    def GenerateScripts(self):
        ...
        preUpgrade.CallFunction(preUpgrade.StopWSManService())
        preUpgrade.CallFunction(preUpgrade.StopPegasusService())
        preUpgrade.CallFunction(preUpgrade.RemoveWSManService())
        preUpgrade.CallFunction(preUpgrade.RemovePegasusService())
