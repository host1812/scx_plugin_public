...
class HPUXPackageFile(Installer):
    ...
    def GenerateScripts(self):
        ...
        configure.CallFunction(configure.ConfigurePegasusService())
        configure.WriteLn('set -e')
        configure.CallFunction(configure.StartPegasusService())
        configure.WriteLn('set +e')
        ...
        unconfigure.CallFunction(unconfigure.StopPegasusService())
        unconfigure.CallFunction(unconfigure.RemovePegasusService())
