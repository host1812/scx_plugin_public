...
#error Platform not supported
        ...
        bool m_bRecomputeSleep;   //!< Recompute sleep time (timeout?)
#elif defined(WIN32)
...
*/
        SCXConditionHandle(SCXCondition& cond)
            : m_cond(cond)
          { m_cond.BeginCondition(); }

/*----------------------------------------------------------------------------*/
/**
    Destructor
*/
        ~SCXConditionHandle() { m_cond.EndCondition(); }
...
/**
    ...
    calling convention)
*/
        enum SCXCondition::eConditionResult Wait() { return m_cond.Wait(); }
