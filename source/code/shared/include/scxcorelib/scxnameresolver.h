...
namespace SCXCoreLib 
{
    ...
    */
    ...
    protected:
        ...
        // Provide a virtual getenv() function that we can override for test
        virtual char *getenv(const char *name) const { return ::getenv(name); }

        // Provide a virtual geteuid() function that we can override for test
        virtual uid_t geteuid() const { return ::geteuid(); }
    ...
    /**
       ...
       wstring fqdn_hostname = mi.GetHostDomainname();
    ...
    */
    ...
    public:
        ...
        std::wstring GetHostname() const { return GetHandle()->GetHostname(); }
