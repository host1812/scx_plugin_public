...
/**
    ...
    \note that implementation does not support abandoned locks (TI#569),
       ...
       again by the holding thread (generates exception). A lock may not
       be released if not held by the calling thread.
...
namespace SCXCoreLib
{
    ...
    */
    ...
    public:
        ...
        SCXThreadLockHandle(const std::wstring& lockName);
    ...
    */
    ...
    public:
        ...
        SCXThreadLock(const std::wstring& nameOfLock, bool aquire = true);
