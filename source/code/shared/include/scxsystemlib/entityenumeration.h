...
namespace SCXSystemLib
{
    ...
    */
    ...
    public:
        ...
        void RemoveInstance(typename EntityEnumeration<Inst>::EntityIterator iter);
    ...
    */
    template<class Inst>
    void EntityEnumeration<Inst>::RemoveInstance(typename EntityEnumeration<Inst>::EntityIterator iter)
    {
