...
namespace SCXSystemLib  
{
    ...
    */
    ...
    /** Max length of filename in /proc filesystem. */
    const size_t PROCPATH_LEN = 30;
    
    /*----------------------------------------------------------------------------*/

    /**
        Class that represents an instances of a unix process.
    ...
    */
    ...
    private:
#endif // defined(linux) || defined(sun) || defined(aix)
...
#if defined(linux)
        char m_procStatName[PROCPATH_LEN];      //!< Name of /proc/#/stat file
        char m_procStatMName[PROCPATH_LEN];     //!< Name of /proc/#/statm file
...
#if defined(sun)
        char m_procPsinfoName[PROCPATH_LEN];    //!< Name of /proc/#/psinfo file
        char m_procStatusName[PROCPATH_LEN];    //!< Name of /proc/#/status file (protected)
        char m_procUsageName[PROCPATH_LEN];     //!< Name of /proc/#/usage file
