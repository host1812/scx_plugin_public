...
namespace SCXCoreLib
{
    ...
    */
    ...
    /**
       ...
       \param[in] src  A wstring that should be used to initialize the filename.
    ...
    */
    ...
    /*----------------------------------------------------------------------------*/
    /**
       wstring cast operator.

       \returns    Path as a single wstring.
    ...
    */
    ...
    /*----------------------------------------------------------------------------*/
    /**
       Assignment operator for wstring.

       \param[in] op Path to assign as a wstring.
       \returns      Reference to current path.
