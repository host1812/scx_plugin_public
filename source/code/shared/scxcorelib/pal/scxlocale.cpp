...
namespace SCXCoreLib {
    ...
    */
    std::vector<std::wstring> SCXLocaleContext::m_Errors;
#endif
    ...
    */
    ...
    const std::vector<std::wstring>& SCXLocaleContext::GetErrors()
    {
        return m_Errors; 
    }
     ...
     */
    std::wstring SCXLocaleContext::GetActiveLocale()
    {
    ...
    */
    std::wstring SCXLocaleContext::GetCtypeName()
    {
