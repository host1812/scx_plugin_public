...
namespace SCXCoreLib
{
    ...
    */
    SCXThread::SCXThread(SCXThreadProc proc, SCXThreadParam* param /*= 0*/)
        : m_threadID(0)
        , m_paramHandle(0)
#if defined(WIN32)
        , m_threadHandle(new HANDLE(INVALID_HANDLE_VALUE))
    ...
    */
    SCXThread::SCXThread(SCXThreadProc proc, const SCXThreadParamHandle& param)
        : m_threadID(0)
    ...
    */
    void SCXThread::SCXThreadStartHelper(SCXThreadProc proc)
    {
...
#elif defined(SCX_UNIX)
        if (0 != pthread_create(&m_threadID, NULL, ThreadStartRoutine, p))
        {
    ...
    */
    SCXThread::~SCXThread()
    {
        ...
        {
            // Detach current thread to reclaim thread resources automatically.
    ...
    */
    void SCXThread::Start(SCXThreadProc proc, SCXThreadParam* param /*= 0*/)
    {
    ...
    */
    void SCXThread::Start(SCXThreadProc proc, const SCXThreadParamHandle& param)
    {
        if (0 != m_threadID)
        {
    ...
    */
    void SCXThread::Wait()
    {
        ...
        if (0 != m_threadID)
        {
            (void)pthread_join(m_threadID, 0);
            m_threadID = 0;
        }
#endif
    }
