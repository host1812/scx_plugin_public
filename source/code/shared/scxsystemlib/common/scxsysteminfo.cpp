...
namespace SCXSystemLib
{
    ...
    */
    const std::wstring SystemInfo::DumpString() const
    {
...
#error Not implemented on this platform
  ...
  #error Platform not defined
    ...
    */
    std::wstring SystemInfo::GetDefaultSudoPath() const
    {
    ...
    */
    std::wstring SystemInfo::GetShellCommand(const std::wstring& command) const
    {
    ...
    /**
       ...
       \returns Command to execute for elevation of input command.
    */
    std::wstring SystemInfo::GetElevatedCommand(const std::wstring& command) const
    {
        ...
        std::wstring elevatedCommand = GetDefaultSudoPath();
