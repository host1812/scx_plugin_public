...
#if defined(aix)
    : SCX_AdminServiceControl(L"scxcimserver", L"/usr/bin/startsrc -s scx-cimd", L"/usr/bin/stopsrc -c -s scx-cimd")
#elif defined(hpux)
    : SCX_AdminServiceControl(L"scxcimserver", L"/sbin/init.d/scx-cimd start", L"/sbin/init.d/scx-cimd stop")
#elif defined(linux)
    : SCX_AdminServiceControl(L"scxcimserver", L"/etc/init.d/scx-cimd start", L"/etc/init.d/scx-cimd stop")
#elif defined(macos)
    : SCX_AdminServiceControl(L"scxcimserver", L"launchctl load -w /Library/LaunchDaemons/com.microsoft.scx-cimd.plist", L"launchctl unload -w /Library/LaunchDaemons/com.microsoft.scx-cimd.plist")
#elif defined(sun)
#if (PF_MAJOR == 5) && (PF_MINOR > 9)
    : SCX_AdminServiceControl(L"scxcimserver", L"/usr/sbin/svcadm -v enable -s svc:/application/management/scx-cimd", L"/usr/sbin/svcadm -v disable -s svc:/application/management/scx-cimd")
#else
    : SCX_AdminServiceControl(L"scxcimserver", L"/etc/init.d/scx-cimd start", L"/etc/init.d/scx-cimd stop")
#endif
#else
    : SCX_AdminServiceControl(L"scxcimserver", L"", L"")
#endif
{
...
SCX_ProviderServiceControl::SCX_ProviderServiceControl()
    : SCX_AdminServiceControl(L"scxcimprovagt", L"", L"")
{
